...
import { Server, Cloud, Shield, Network, Zap, Database } from 'lucide-react';

const floatingIcons = [
  { Icon: Server, delay: 0 },
  { Icon: Cloud, delay: 0.5 },
  { Icon: Shield, delay: 1 },
  { Icon: Network, delay: 1.5 },
  { Icon: Zap, delay: 2 },
    ...
    <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#F5F5F7] via-white to-[#E8F0FE]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-20">
        ...
        >
          ...
          >
            End-to-end IT solutions designed for businesses across India
          </motion.p>
          ...
          >
            From web design to cloud computing, IT support to infrastructure projects—we deliver 
            comprehensive technology solutions that empower your business to thrive in the digital age.
          </motion.p>
        </motion.div>
      </div>
